  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-2">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Delegações Temporárias</h1>
        <button
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-6 text-sm">
        Conceda temporariamente a um GERENTE ou ADMIN o direito de aprovar operações críticas em seu lugar.
      </p>
