  ...
  if (loading) {
    return (
      <div className="text-center py-12">
        ...
        <p className="mt-4 text-gray-300">Carregando usuários...</p>
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg shadow-xl p-6">
          <p className="text-sm text-gray-400">KYC Completo</p>
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg shadow-xl p-6">
          <p className="text-sm text-gray-400">Sem KYC</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-gray-900 border border-gray-600 text-white rounded-lg focus:ring-2 focus:ring-blue-500"
            />
          </div>
          <div>
          ...
          <table className="w-full">
            <thead className="bg-gray-900 border-b border-gray-700">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase">KYC</th>
                <th className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase">Role</th>
                <th className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase">Reputação</th>
                <th className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase">Transações</th>
            ...
            <tbody className="divide-y divide-gray-700">
              {filteredUsers.map((user) => (
                <tr key={user.id} className="hover:bg-gray-700/50 transition">
                  ...
                  <td className="px-6 py-4">
                    <span className="text-sm text-white font-semibold">{user.reputationScore}</span>
                  </td>
                  <td className="px-6 py-4">
                    <span className="text-sm text-gray-300">{user.totalTransactions}</span>
                  </td>
                  <td className="px-6 py-4">
