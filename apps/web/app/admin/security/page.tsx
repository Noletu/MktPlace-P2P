...
export default function AdminSecurityPage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-white">Segurança da Conta</h1>
        <p className="text-gray-400 mt-2">Configure a autenticação de dois fatores (2FA) para proteger sua conta de administrador</p>
      </div>
      ...
      {step === 'status' && status && (
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
          <h2 className="text-xl font-bold text-white mb-4">Autenticação de Dois Fatores (2FA)</h2>
          ...
          {status.enabled ? (
            <div className="space-y-4">
              ...
              <div className="p-4 bg-gray-900/50 rounded-lg">
                <p className="text-sm text-gray-400">Backup Codes Disponíveis</p>
                <p className="text-2xl font-bold text-white">{status.backupCodesCount}</p>
                <p className="text-xs text-gray-500 mt-1">Use em caso de perda do acesso ao app autenticador</p>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Sua conta está vulnerável. Ative o 2FA para maior segurança</p>
                </div>
              </div>

              <div className="p-4 bg-gray-900/50 rounded-lg">
                <h3 className="font-semibold text-white mb-2">Por que ativar o 2FA?</h3>
      ...
      {step === 'setup' && qrCode && (
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
          <h2 className="text-xl font-bold text-white mb-4">Configurar Autenticação de Dois Fatores</h2>

          <div className="space-y-6">
            <div>
              <h3 className="font-semibold text-white mb-2">Passo 1: Instale um app autenticador</h3>
              <p className="text-sm text-gray-400 mb-3">
                Se você ainda não tem, instale um aplicativo como:
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-gray-700 text-gray-300 rounded text-sm">Google Authenticator</span>
                <span className="px-3 py-1 bg-gray-700 text-gray-300 rounded text-sm">Microsoft Authenticator</span>
                <span className="px-3 py-1 bg-gray-700 text-gray-300 rounded text-sm">Authy</span>
              </div>
            </div>

            <div>
              <h3 className="font-semibold text-white mb-2">Passo 2: Escaneie o QR Code</h3>
            ...
            <div>
              <h3 className="font-semibold text-white mb-2">Ou digite o código manualmente:</h3>
              <div className="flex items-center gap-2">
                <code className="flex-1 p-3 bg-gray-900 text-gray-300 rounded font-mono text-sm break-all">
                  {secret}
                </code>
                <button
            ...
            <form onSubmit={handleEnable2FA} className="space-y-4">
              <div>
                <h3 className="font-semibold text-white mb-2">Passo 3: Digite o código de 6 dígitos</h3>
                <input
                  type="text"
                  value={token}
      ...
      {step === 'complete' && showBackupCodes && backupCodes.length > 0 && (
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
          <div className="mb-6">
            <div className="flex items-center gap-3 p-4 bg-green-500/10 border border-green-500/30 rounded-lg mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Sua conta agora está mais segura</p>
              </div>
            </div>
          ...
          <div className="bg-gray-900 border border-gray-700 rounded-lg p-6 mb-6">
            <h3 className="font-semibold text-white mb-4">Seus Backup Codes:</h3>
            <div className="grid grid-cols-2 gap-3">
              {backupCodes.map((code, index) => (
                <div key={index} className="flex items-center gap-2 p-3 bg-gray-800 rounded">
                  <span className="text-gray-500 text-sm">{index + 1}.</span>
                  <code className="flex-1 text-white font-mono">{code}</code>
                </div>
              ))}
            </div>
          </div>
