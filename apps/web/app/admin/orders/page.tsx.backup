...
export default function OrdersPage() {
  ...
  if (loading) {
    return (
      <div className="text-center py-12">
        ...
        <p className="mt-4 text-gray-300">Carregando pedidos...</p>
      </div>
    );
  }
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-white mb-8">Gerenciar Pedidos</h1>
            ...
            <tbody className="divide-y divide-gray-700">
              {filteredOrders.map((order) => (
                <tr key={order.id} className="hover:bg-gray-700/50 transition">
                  ...
                  <td className="px-6 py-4">
                    <div>
                      <p className="text-sm font-medium text-white">{order.cryptoType}</p>
                      <p className="text-xs text-gray-400">{order.cryptoAmount}</p>
                    </div>
                  </td>
                  <td className="px-6 py-4">
