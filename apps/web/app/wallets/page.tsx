...
export default function WalletsPage() {
  ...
  const handleSyncBalance = async (walletId: string) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/v1/wallets/${walletId}/sync`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
  ...
  const fetchTransactions = async (walletId: string) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/v1/wallets/${walletId}/transactions`, {
        headers: {
          'Authorization': `Bearer ${token}`,
        },
      });
  ...
  const handleAddTestBalance = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/v1/wallets/${testBalanceModal.walletId}/test-balance`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
