...
interface ReviewStatsProps {
  ...
  compact?: boolean; // Se true, mostra apenas o resumo
}
...
export function ReviewStats({ stats, compact = false }: ReviewStatsProps) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Estatísticas de Avaliações</h2>

      {/* Overall Rating */}
      <div className={`text-center ${compact ? '' : 'mb-8 pb-8 border-b border-gray-200 dark:border-gray-700'}`}>
      ...
      {/* Mostrar detalhes apenas se não for compact */}
      {!compact && (
        <>
          {/* Rating Distribution */}
          <div className="space-y-3 mb-8 pb-8 border-b border-gray-200 dark:border-gray-700">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Distribuição</h3>
          ...
          {(stats.averageReliability || stats.averageCommunication || stats.averageSpeed) && (
            <div className="space-y-4">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Médias por Categoria</h3>

              {stats.averageReliability && (
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Confiabilidade</span>
              ...
              {stats.averageCommunication && (
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Comunicação</span>
                    <span className="text-sm font-semibold text-gray-900 dark:text-white">
              ...
              {stats.averageSpeed && (
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Rapidez</span>
                    <span className="text-sm font-semibold text-gray-900 dark:text-white">
