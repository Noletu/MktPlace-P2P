...
export default function KYCLevel1Form() {
  ...
  if (success) {
    return (
      <div className="max-w-2xl mx-auto p-8 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-lg">
        ...
        <p className="text-green-600 dark:text-green-400 text-sm">Redirecionando para o dashboard...</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto p-8 bg-white dark:bg-gray-800 rounded-lg shadow-md">
      <h2 className="text-2xl font-bold mb-2 dark:text-white">Verificação KYC - Nível 1</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* CPF */}
        <div>
          <label htmlFor="cpf" className="block text-sm font-medium text-gray-700 dark:text-white mb-2">
            CPF *
          </label>
          <input
            type="text"
      ...
      <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
        <h4 className="font-semibold text-gray-900 dark:text-white mb-2 text-sm">Benefícios do KYC Level 1:</h4>
      ...
      <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
        <h4 className="font-semibold text-gray-900 dark:text-white mb-2 text-sm">Próximos níveis:</h4>
        <ul className="text-xs text-gray-600 dark:text-gray-300 space-y-1">
